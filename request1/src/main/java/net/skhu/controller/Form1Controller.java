...
public class Form1Controller {
    ...
    @PostMapping("form1/text3")
    public String text3(Model model, String param1, String param2) {
        System.out.println(param1);
        System.out.println(param2);
        System.out.println(new Date());
        model.addAttribute("param1", param1 + " a");
        model.addAttribute("param2", param2 + " a");
        model.addAttribute("now", new Date());
        return "form1/text3";
    }

    @GetMapping("form1/text4")
    ...
    @PostMapping("form1/text4")
    public String text4(Model model, String param1, String param2) {
        System.out.println(param1);
        System.out.println(param2);
        System.out.println(new Date());
        model.addAttribute("param1", param2);
        model.addAttribute("param2", param1);
        model.addAttribute("now", new Date());
        return "form1/text4";
    }
}